...
export default function FavoriteUpdateForm(props) {
  const {
    id: idProp,
    favorite: favoriteModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Favorite, idProp)
        : favoriteModelProp;
      setFavoriteRecord(record);
    };
    queryData();
  }, [idProp, favoriteModelProp]);
  React.useEffect(resetStateValues, [favoriteRecord]);
  const validations = {
    userID: [],
    favType: [],
    favID: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Favorite.copyOf(favoriteRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "FavoriteUpdateForm")}
      {...rest}
    >
      <TextField
        label="User id"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || favoriteModelProp)}
