      ...
      <div className="landing-page-content">
        ...
        <div className="landing-page-features">
          <div className="landing-page-feature">
            <img src="/asset-mngt.jpeg" alt="Feature 1" className="landing-page-feature-image" />
            <h3>Asset Tracking</h3>
            <p>Effortlessly track and manage your real estate assets in one central location.</p>
          </div>
          <div className="landing-page-feature">
            <img src="/financial-analysis.jpeg" alt="Feature 2" className="landing-page-feature-image" />
            <h3>Financial Analysis</h3>
            <p>Analyze the financial performance of your assets with detailed reports and insights.</p>
          </div>
          <div className="landing-page-feature">
            <img src="/track-expenses.webp" alt="Feature 3" className="landing-page-feature-image" />
